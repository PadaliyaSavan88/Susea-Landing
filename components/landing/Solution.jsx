...
const ROWS = [
  ['layout-dashboard', 'var(--blue-600)', 'var(--blue-50)', 'Centralized pricing dashboard', 'Every tariff, every carrier, one searchable surface', '/pricing'],
  ['file-output', 'var(--orange-600)', 'var(--orange-50)', 'AI quotation engine', 'Generates customer-ready quotes from cargo input in <90s', '/quotes'],
  ['scale', 'var(--amber-600)', 'var(--amber-50)', 'Carrier comparison engine', 'Spot rates, contract rates, transit time, free time — side by side', '/compare'],
  ['file-scan', 'var(--good-600)', 'var(--good-50)', 'Tariff intelligence system', 'Auto-extracts pricing from PDFs, XLS, email and WhatsApp', '/tariffs'],
  ['sliders-horizontal', 'var(--blue-600)', 'var(--blue-50)', 'Surcharge & margin automation', 'BAF, CAF, THC, LSS, ISPS — calculated, applied, audited', '/automation'],
]
