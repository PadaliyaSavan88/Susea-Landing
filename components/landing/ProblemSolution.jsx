      ...
      <div className="container">
        ...
        <div className="split">
          <div className="panel-lg min">
            ...
            <p className="panel-sub">A typical FCL quote touches inboxes, chats, three Excel sheets and a printed tariff. Nothing reconciles.</p>
          ...
          <div className="panel-lg min">
            ...
            <div className="sol-banner">
              ...
              <div>
                <div className="sb-title">Susea consolidates 1 inbox + 6 tariffs + 200 carriers</div>
                {/* <div className="sb-sub">…into a single live pricing surface your ops team actually trusts.</div> */}
              </div>
            </div>
          </div>
        </div>
