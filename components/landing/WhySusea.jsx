...
export default function WhySusea() {
  ...
  const v90 = useCountUp(90, run),
    v60 = useCountUp(60, run),
    v200 = useCountUp(200, run),
    v3 = useCountUp(3, run);
      ...
      <div className="container">
        <div className="sec-head">
          <span className="eyebrow">
            <span className="dot"></span> Why Susea
          </span>
          <h2 className="h-section">
            Faster quotes. Tighter margins. <br />
            Smarter awards.
          </h2>
          <p className="lead">
        ...
        <div className="impact-grid">
          <div className="stat">
            <div className="v">
              <span className="mono">{v90}</span>
              <span className="u">%</span>
            </div>
            <div className="l">
              Faster quotation creation across pricing desks running Susea.
            </div>
          </div>
          <div className="stat">
            <div className="v">
              <span
                style={{ fontSize: 18, fontWeight: 600, color: "var(--ink-3)" }}
              >
                up to{" "}
              </span>
              <span className="mono">{v60}</span>
              <span className="u" style={{ color: "var(--orange-600)" }}>
                %
              </span>
            </div>
            <div className="l">
              Lower freight cost once your agents compete in a live auction.
            </div>
          </div>
          <div className="stat">
            <div className="v">
              <span className="mono">{v200}</span>
              <span className="u">+</span>
            </div>
            <div className="l">
              Carrier rates compared on every quote, in one view.
            </div>
          </div>
          <div className="stat">
            <div className="v">
              <span className="mono">{v3}</span>
              <span className="u" style={{ color: "var(--orange-600)" }}>
                d
              </span>
            </div>
            <div className="l">
              From launching a tender to a signed, audited award.
            </div>
          </div>
        </div>
        ...
        <div className="ba">
          <div className="col">
            ...
            <h3 style={{ color: "var(--bad-600)" }}>
              Spreadsheets &amp; sequential calls
            </h3>
            <ul>
              {before.map((t, i) => (
                <li key={i}>
                  <span className="b-ico">✕</span> {t}
                </li>
              ))}
            </ul>
          </div>
          <div className="col after">
            ...
            <h3 style={{ color: "var(--blue-700)" }}>
              One AI pricing &amp; procurement OS
            </h3>
            <ul>
              {after.map((t, i) => (
                <li key={i}>
                  <span className="a-ico">✓</span> <span>{t}</span>
                </li>
              ))}
            </ul>
          </div>
